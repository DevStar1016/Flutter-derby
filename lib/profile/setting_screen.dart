...
import 'package:goevent2/profile/sub_setting_screen.dart';
...
class SettingScreen extends StatefulWidget {
  final String title;
  const SettingScreen(this.title, {Key? key}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      settingWidget(
                        tital: "More Settings".tr,
                        image: "image/settings.png",
                        onTap: () {
                          Get.to(() => SubSettingScreen(""));
                        },
                      ),
                      settingWidget(
                        tital: "Logout".tr,
