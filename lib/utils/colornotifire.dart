...
class ColorNotifire with ChangeNotifier {
  ...
  get finalticketcolore =>
      isDark ? const Color(0xff161616) : const Color(0xff5669FF);
  get containercolore => isDark ? const Color(0xff1C1C1C) : Colors.white;
  get homecontainercolore =>
      isDark ? const Color(0xff1C1C1C) : const Color(0xff000000);
  get bottommenucolore =>
      isDark ? Colors.white : const Color(0xff6978A0).withOpacity(.80);
